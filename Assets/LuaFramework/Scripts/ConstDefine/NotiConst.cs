...
public class NotiConst
{
    ...
    public const string SET_PROGRESS_MAX = "SetProgressMax";        //设置最大值
    public const string SET_PROGRESS = "SetProgress";               //设置进度
    public const string SET_ACTIVE = "SetActive";                   //设置Active                              
}
