...
public class Packager {
    ...
    static void HandleExampleBundle() {
        ...
        string content = File.ReadAllText(AppDataPath + "/AssetBundleInfo.csv");
        string[] contents = content.Split(new string[] { "\r\n" }, System.StringSplitOptions.RemoveEmptyEntries);
        for (int i = 0; i < contents.Length; i++)
        {
            string[] a = contents[i].Split(',');
            AddBuildMap(a[0] + AppConst.ExtName, a[1], a[2]);
        }

        //AddBuildMap("prompt" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Examples/Builds/Prompt");
        //AddBuildMap("message" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Examples/Builds/Message");
        //AddBuildMap("login" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Examples/Builds/Login");
        //AddBuildMap("createrole" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Examples/Builds/CreateRole");
        //AddBuildMap("mainscene" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Examples/Builds/MainScene");
        //AddBuildMap("war" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Examples/Builds/War");

        //AddBuildMap("prompt_asset" + AppConst.ExtName, "*.png", "Assets/LuaFramework/Examples/Textures/Prompt");
        //AddBuildMap("shared_asset" + AppConst.ExtName, "*.png", "Assets/LuaFramework/Examples/Textures/Shared");
        //AddBuildMap("baby_asset" + AppConst.ExtName, "*.jpg", "Assets/LuaFramework/Examples/Textures/Shared/Baby");
        //AddBuildMap("login_asset" + AppConst.ExtName, "*.png", "Assets/LuaFramework/Examples/Textures/Login");
        //AddBuildMap("createrole_asset" + AppConst.ExtName, "*.png", "Assets/LuaFramework/Examples/Textures/CreateRole");
        //AddBuildMap("mainscene_asset" + AppConst.ExtName, "*.png", "Assets/LuaFramework/Examples/Textures/MainScene");
        //AddBuildMap("war_asset" + AppConst.ExtName, "*.png", "Assets/LuaFramework/Examples/Textures/War");
    }
